...
public class AddMoviesActivity extends AppCompatActivity {
    ...
    private void addMovies(String name, String cast, String trailer, String content, String nation, String category, String year, String director, String time){
        ...
        int clickcount = 0;
        Movies movies = new Movies(name, cast, trailer, content, nation, category, year, stars, id, String.valueOf(clickcount), director, time, getDateTime("HH:mm:ss dd/MM/yyyy"));
    ...
    public class Movies {
        public String name, cast, trailer, content, nation, category, year, id, viewcount, clickcount, director, time, postingdate;
        public stars stars;
        ...
        public Movies(String name, String cast, String trailer, String content, String nation, String category,
                      String year, stars stars, String id, String clickcount, String director, String time, String postingdate) {
            this.name = name;
            this.cast = cast;
